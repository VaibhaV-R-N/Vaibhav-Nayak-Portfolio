...
export default function Page() {
  return (
    <div className='w-full h-auto p-3 flex flex-col items-center justify-center gap-10'>
        ...
        <h4>Gmail API Information</h4>
        <p className='text-white text-xl'>In order to send emails through the contact form, we use the Gmail API. This may involve collecting and processing your Gmail address and other necessary data for email communication.</p>
        ...
        <p className='text-white text-xl'>We take reasonable measures to protect your information, but no online transmission or storage is 100% secure. Please use caution when submitting personal information online.</p>
        <h3 className='text-yellow-400 text-2xl'>Your Choices</h3>
        <p className='text-white text-xl'>You can contact us at vaibhavnayak243@gmail.com to update or delete your personal information.</p>
        <h3 className='text-yellow-400 text-2xl'>Changes to This Privacy Policy</h3>
        <p className='text-white text-xl'>We may update this Privacy Policy to reflect changes in our practices or for other operational, legal, or regulatory reasons.</p>
        <h3 className='text-yellow-400 text-2xl'>Contact Us</h3>
        <p className='text-white text-xl'>If you have questions about this Privacy Policy, please contact us at vaibhavnayak243@gmail.com .</p>
        <p className='text-white text-xl'>This Privacy Policy was last updated on 22/01/24.</p>
    </div>
  )
}
